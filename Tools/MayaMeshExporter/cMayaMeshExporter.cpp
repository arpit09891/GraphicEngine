...
//			fout << std::fixed;
				...
				"{\n";
			{
					...
					for (size_t i = 0; i < i_vertexArray.size(); i++)
					{
						fout << "{\n";
						{
							fout << "position = "
								"{\n";
							{
								//fout << "%a, %a, %a \n", i_vertexArray[i].vertex.x, i_vertexArray[i].vertex.y, i_vertexArray[i].vertex.z;
							...
							fout << "color = "
								"{\n";
							{
								//fout << "%f, %f, %f, %f \n", i_vertexArray[i].vertex.r, i_vertexArray[i].vertex.g, i_vertexArray[i].vertex.b, i_vertexArray[i].vertex.a;
								fout << i_vertexArray[i].vertex.r << "," << i_vertexArray[i].vertex.g << "," << i_vertexArray[i].vertex.b << "," << i_vertexArray[i].vertex.a << "\n";
							}
							fout << "}, \n";
							...
							{
								//fout << "%f, %f, %f, %f \n", i_vertexArray[i].vertex.r, i_vertexArray[i].vertex.g, i_vertexArray[i].vertex.b, i_vertexArray[i].vertex.a;
								fout << i_vertexArray[i].vertex.u << "," << i_vertexArray[i].vertex.v << "\n";
							}
							fout << "}, \n";
						}
						fout << "},\n";
				...
				//	"{\n";
				//{
				//	fout << "0.0 , 0.0, 0.0"; //TODO set mesh position
				//}
				//fout << "} \n";
